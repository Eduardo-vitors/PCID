...
module tb_RemoteController_ManualCheck;
    ...
    initial begin
        ...
        $display("Pacote enviado. Aguardando reação do hardware...");
...
fork : verif
            begin
                ...
                if (dados_brutos[15:8] == ~dados_brutos[7:0]) begin
                    ...
                    case (dados_brutos[15:8])
                        ...
                        default: $display("NAO RECONHECE A TECLA (Codigo %h desconhecido)", dados_brutos[15:8]);
                    endcase
        ...
        join // <--- MUDANÃA AQUI (de join_any para join)

        $stop; // Agora ele vai reconhecer isso corretamente
    end
endmodule